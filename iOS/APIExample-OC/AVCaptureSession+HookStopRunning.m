//
//  AVCaptureSession+HookStopRunning.m
//  ZegoSimpleDemo
//
//  Created by zhangwei on 2023/12/21.
//

#import "AVCaptureSession+HookStopRunning.h"
#import <objc/runtime.h>

@implementation AVCaptureSession (HookStopRunning)
...
+ (void)load {
    ...
    dispatch_once(&onceToken, ^{
        ...
        SEL originalInstanceSelector = @selector(stopRunning);
        SEL swizzledInstanceSelector = @selector(zw_stopRunning);
...
- (void)zw_stopRunning {
    ...
    NSLog(@"--stopRunning耗时:%f", endTime - startTime);
}
@end
